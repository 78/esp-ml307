...
public:
    ...
    virtual NetworkResult<> Connect(const std::string broker_address, int broker_port,
    ...
    virtual void OnConnected(std::function<void()> callback) {
    ...
    virtual void OnError(std::function<void(const std::string& error)> callback) {
